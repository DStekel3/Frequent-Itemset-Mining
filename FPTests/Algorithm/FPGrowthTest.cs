...
namespace FPTests
{
  ...
  public class FPGrowthTest
  {
    ...
    public void CreateFPTreeAndGenerateFrequentItemsetsTest()
    {
      ...
      //IInputDatabaseHelper inDatabaseHelper = new FileInputDatabaseHelper("mushroom"); // TODO: Initialize to an appropriate value
      //IOutputDatabaseHelper outDatabaseHelper = new FileOutputDatabaseHelper(@"D:\temp\"); ; // TODO: Initialize to an appropriate value
      //int expected;
      //float minSup = 0.5f;
      //int actual;

      //actual = target.CreateFpTreeAndGenerateFrequentItemsets(inDatabaseHelper, outDatabaseHelper, minSup);

      //if(inDatabaseHelper.DatabaseName == "mushroom" && minSup == 0.5f)
